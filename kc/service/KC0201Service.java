 ...
 */
@Service
public class KC0201Service {
	/**
	 * log 처리를 위한 변수 선언
	 */
	private static final Logger logger = LoggerFactory.getLogger(KC0201Service.class);
	...
	public List<Map<String, Object>> retrieveWO0301List(Map<String, Object> data) {
		return dao.queryForMapList("kc0201.retrieveWO0301List", data);
	}
	...
	public List<Map<String, Object>> retrieveWO0301ListToTree(Map<String, Object> data) {
		return dao.queryForMapList("kc0201.retrieveWO0301ListToTree", data);
	}
	...
	public List<Map<String, Object>> retrieveWoRJobList(Map<String, Object> data) {
		return dao.queryForMapList("kc0201.retrieveWoRJobList", data);
	}
	...
	public List<Map<String, Object>> retrieveWoRCraftList(Map<String, Object> data) {
		return dao.queryForMapList("kc0201.retrieveWoRCraftList", data);
	}
	...
	public List<Map<String, Object>> retrieveWoRMaterialList(Map<String, Object> data) {
		return dao.queryForMapList("kc0201.retrieveWoRMaterialList", data);
	}
	...
	public List<Map<String, Object>> retrieveWoSymList(Map<String, Object> data) {
		return dao.queryForMapList("kc0201.retrieveWoSymList", data);
	}
	...
	public List<Map<String, Object>> retrieveWoResultList(Map<String, Object> data) {
		return dao.queryForMapList("kc0201.retrieveWoResultList", data);
	}
	...
	public void saveWoProcessAll(
		...
		if(resultList.size() > 0) {
			...
			dao.update("kc0201.updateWO0301WorkDesc", woNoData);
		}
	...
	public void saveJob(GridData<HashMap> gridData) {
		gridData.forEachRow(new AbstractRowStatusCallback<HashMap>() {
			public void insert(HashMap record, int index) {
				...
				dao.update("kc0201.insertJob", record);
			}

			public void update(HashMap newRecord, HashMap oldRecord, int arg2) {
				newRecord.put("fnlEditUserId", UserInfo.getUserId());

				dao.update("kc0201.updateJob", newRecord);
			}

			public void delete(HashMap record, int index) {
				dao.update("kc0201.deleteJob", record);
			}
		});
	}
	...
	public void saveCraft(GridData<HashMap> gridData) {
		gridData.forEachRow(new AbstractRowStatusCallback<HashMap>() {
			public void insert(HashMap record, int index) {
				...
				record.put("fnlEditUserId", UserInfo.getUserId());
				record.put("orgCd", UserInfo.getOrgCd());
				dao.update("kc0201.insertCraft", record);
				if("1".equals(record.get("inOutDiv"))) {
					dao.update("kc0201", record);
				} else if("2".equals(record.get("inOutDiv"))) {
					dao.update("kc0201.updateEtcCost", record);
				}

				dao.update("kc0201.updateWO0301Craft", record);
			}

			public void update(HashMap newRecord, HashMap oldRecord, int arg2) {
				newRecord.put("fnlEditUserId", UserInfo.getUserId());

				dao.update("kc0201.updateCraft", newRecord);
				if("1".equals(newRecord.get("inOutDiv"))) {
					dao.update("kc0201.updateLaborCost", newRecord);
				} else if("2".equals(newRecord.get("inOutDiv"))) {
					dao.update("kc0201.updateEtcCost", newRecord);
				}

				dao.update("kc0201.updateWO0301Craft", newRecord);
			}

			public void delete(HashMap record, int index) {
				dao.update("kc0201.deleteCraft", record);
				if("1".equals(record.get("inOutDiv"))) {
					dao.update("kc0201.updateLaborCost", record);
				} else if("2".equals(record.get("inOutDiv"))) {
					dao.update("kc0201.updateEtcCost", record);
				}
	...
	public void saveMaterial(GridData<HashMap> gridData) {
		gridData.forEachRow(new AbstractRowStatusCallback<HashMap>() {
			public void insert(HashMap record, int index) {
				...
				dao.update("kc0201.insertMaterial", record);
				dao.update("kc0201.updateWO0301Pt", record);
				dao.update("kc0201.updatePtCost", record);
			...
			public void update(HashMap newRecord, HashMap oldRecord, int arg2) {
				...
				dao.update("kc0201.updateMaterial", newRecord);
				dao.update("kc0201.updateWO0301Pt", newRecord);
				dao.update("kc0201.updatePtCost", newRecord);

			}

			public void delete(HashMap record, int index) {
				record.put("fnlEditUserId", UserInfo.getUserId());
				dao.update("kc0201.deleteMaterial", record);
				dao.update("kc0201.updateWO0301Pt", record);
			}
		});
	...
	public void saveSym(GridData<HashMap> gridData) {
		gridData.forEachRow(new AbstractRowStatusCallback<HashMap>() {
			public void insert(HashMap record, int index) {
				...
				dao.update("kc0201.insertSym", record);
			}
			...
			public void update(HashMap newRecord, HashMap oldRecord, int arg2) {
				...
				dao.update("kc0201.updateSym", newRecord);
			}

			public void delete(HashMap record, int index) {
				dao.update("kc0201.deleteSym", record);
			}
		});
	...
	public void saveResult(GridData<HashMap> gridData) {
		gridData.forEachRow(new AbstractRowStatusCallback<HashMap>() {
			public void insert(HashMap record, int index) {
				...
				record.put("fnlEditUserId", UserInfo.getUserId());
				record.put("orgCd", UserInfo.getOrgCd());
				dao.update("kc0201.insertResult", record);
			...
			public void update(HashMap newRecord, HashMap oldRecord, int arg2) {
				...
				dao.update("kc0201.updateResult", newRecord);
			}

			public void delete(HashMap record, int index) {
				dao.update("kc0201.deleteResult", record);
			}
		});
	...
	public void saveWoCancelWO0301(GridData<HashMap> gridData) {
		gridData.forEachRow(new AbstractRowStatusCallback<HashMap>() {
			public void insert(HashMap record, int index) {
				...
				// 1. 취소할 W/O의 불출된 자재 조회
				wo0301PList = dao.queryForMapList("kc0201.retrieveWo0301PList", record);
				// 2. 불출된 자재가 있는지 체크. 있다면 로직 실행, 없으면 결과서 상태만 UPDATE(wo0301.updateWoCancelWO0301)
				if(wo0301PList.size() > 0) {
					...
					// 3.wo0301P 테이블의 USE_QTY(사용수량) = 0, RETURN_QTY(반납수량) = DISPEND_QTY(불출수량) 으로 수정
					dao.update("kc0201.updateWo0301PCancel", record);

				}
				dao.update("kc0201.updateWoCancelWO0301", record);
	...
	public List<Map<String, Object>> retrieveWO0301Detail(Map<String, Object> data) {
		return dao.queryForMapList("kc0201.retrieveWO0301Detail", data);
	}
