 ...
 */
@Service
public class CO0102Service {
	/**
	 * log 처리를 위한 변수 선언
	 */
	private static final Logger logger = LoggerFactory.getLogger(CO0102Service.class);
	...
	public List<Map<String, Object>> retrieveCO0101MList(Map<String, Object> data) {
		return dao.queryForMapList("co0102.retrieveCO0101MList", data);
	}
	...
	public void saveCO0101M(GridData<HashMap>  gridData) {
		gridData.forEachRow(new AbstractRowStatusCallback<HashMap>() {
			...
			public void insert(HashMap record, int index) {
				...
				dao.update("co0102.insertCO0101M", record);
			}
			...
			public void update(HashMap newRecord, HashMap oldRecord, int arg2) {
				...
				dao.update("co0102.updateCO0101M", newRecord);
			}


			public void delete(HashMap record, int index) {
				dao.update("co0102.deleteCO0101M", record);
				dao.update("co0102.deleteCO0101MByCO0101D", record);
			}
		});
	}
	...
	public List<Map<String, Object>> retrieveCO0101DList(Map<String, Object> data) {
		return dao.queryForMapList("co0102.retrieveCO0101DList", data);
	}
	...
	public void saveCO0101D(GridData<HashMap>  gridData) {
		gridData.forEachRow(new AbstractRowStatusCallback<HashMap>() {
			...
			public void insert(HashMap record, int index) {
				...
				dao.update("co0102.insertCO0101D", record);
			}
			...
			public void update(HashMap newRecord, HashMap oldRecord, int arg2) {
				...
				dao.update("co0102.updateCO0101D", newRecord);
			}


			public void delete(HashMap record, int index) {
				dao.update("co0102.deleteCO0101D", record);
			}
		});
	}
	...
	public List<Map<String, Object>> retrieveStdSpecList(Map<String, Object> data) {
		return dao.queryForMapList("co0102.retrieveStdSpecList", data);
	}
	...
	public List<Map<String, Object>> retrieveSpecItemList(Map<String, Object> data) {
		return dao.queryForMapList("co0102.retrieveSpecItemList", data);
	}
}
