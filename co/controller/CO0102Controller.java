...
import com.bplus.pw.co.service.CO0102Service;
...
public class CO0102Controller {
	/**
	 * log 처리를 위한 변수 선언
	 */
	private static final Logger logger = LoggerFactory.getLogger(CO0102Controller.class);

	@Autowired
	private CO0102Service service;
	 ...
	 * @param response
	 */
	@RequestMapping("retrieveCO0102MList.*")
	 ...
	 * @param response
	 */
	@RequestMapping("retrieveCO0102DList.*")
	 ...
	 * @param response
	 */
	@RequestMapping("retrieveStdSpecList0102.*")
	 ...
	 * @param response
	 */
	@RequestMapping("retrieveSpecItemList0102.*")
